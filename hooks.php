 ...
 * 
 * @package KsfFA_ksf_FA_Loyalty
 * @version 2.4.3
 */

define('SS_ksf_FA_Loyalty', 129 << 8);
...
class hooks_ksf_FA_Loyalty extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_LoyaltyVIEW'] = array(
            SS_ksf_FA_Loyalty | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_LoyaltyMANAGE'] = array(
            SS_ksf_FA_Loyalty | 2, 
            _("Manage ")
        );
