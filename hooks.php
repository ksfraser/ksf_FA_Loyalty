<?php
/**
 * ksf_FA_Loyalty Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_Loyalty', 100 << 8);

class hooks_ksf_FA_Loyalty extends hooks {
    var $module_name = 'ksf_FA_Loyalty';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Loyalty] = _("");
        $security_areas['SA_ksf_FA_LoyaltyVIEW'] = array(SS_ksf_FA_Loyalty | 1, _("View "));
        $security_areas['SA_ksf_FA_LoyaltyMANAGE'] = array(SS_ksf_FA_Loyalty | 2, _("Manage "));
